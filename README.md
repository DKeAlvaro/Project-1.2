...
| engine.timing.intervals.computation  | timeScale |         | Time interval between two calculations, in seconds. By default, when omitted, it is calculated as {step} seconds.                                                                         |
| engine.timing.intervals.notification | timeScale | 0.016   | Time interval between updates to GUI, in seconds. Please note that GUI updates are linked to computations and only done as end of computation operation, thus this number is approximate. |
