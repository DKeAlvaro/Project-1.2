package project12.group19.ui.libgdx;
...
public class Drop extends ApplicationAdapter implements ApplicationListener {
    ...
    public Drop(Configuration configuration) {
        ...
        surface = EngineFactory.createSurface(configuration);
    }
    ...
    public void render() {
        ...
        if (solver == null) {
            ...
            if (Gdx.input.isKeyJustPressed(Input.Keys.B)){
                ...
                bot = new HillClimbingBot(motionHandler, EngineFactory.createCourse(configuration));
